 ...
 *      feeds, the full JSON dataset, and the page's own Markdown mirror.
...
const SITE_LINKS = [
  '</llms.txt>; rel="service-doc"; type="text/plain"; title="Nanolist llms.txt"',
  '</llms.txt>; rel="describedby"; type="text/plain"',
  '</sitemap.xml>; rel="sitemap"; type="application/xml"',
  '</feed.xml>; rel="alternate"; type="application/rss+xml"; title="Nanolist latest listings"',
  '</atom.xml>; rel="alternate"; type="application/atom+xml"; title="Nanolist latest listings"',
  '</recommended.xml>; rel="alternate"; type="application/rss+xml"; title="Nanolist recommended listings"',
  '</listings.json>; rel="alternate"; type="application/json"; title="Nanolist full dataset"',
];
...
/**
 * The Markdown mirror for a page route: /listing/ollama ->
 * /listing/ollama.md, / -> /index.md.
 */
